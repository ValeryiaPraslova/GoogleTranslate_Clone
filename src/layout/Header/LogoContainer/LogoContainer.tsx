...
export const LogoContainer = () => (
  <div className={styles.logoContainer}>
    <IconButton icon={<MenuIcon />} ariaLabel='Главное меню' title='Главное меню'></IconButton>
    <a
      href='https://translate.google.com'
      title='Goodle Переводчик'
      className={styles.googleTranslateLink}
      target='_blank'
    >
      ...
      <h1 className={styles.googleTranslateTitle}>Переводчик</h1>
    </a>
  </div>
);
